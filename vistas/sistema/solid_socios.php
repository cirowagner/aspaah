...
<div class="container_socios">
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="ms-4 d-flex align-items-center fs-5">
            <input type="checkbox"><label class="ms-2">Socios deshabilitados</label>
        </div>
    </div>
                ...
                if(!mysqli_num_rows($res) == 0){
                    while($data = $res->fetch_array()){?>
                        <tr>
                            ...
                            <a class="btn btn-outline-primary py-0" href="javascript:fn_delete(<?php echo $data[0] ?>);">Deshabilitar</a>
                            </div></td>
                        </tr>
                <?php } 
                }else { ?>
...
if(!isset($_POST["search"])){?>
    <nav aria-label="Page navigation example" id="paginador">
